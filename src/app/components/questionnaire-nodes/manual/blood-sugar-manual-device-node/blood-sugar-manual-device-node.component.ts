...
@Component({
  selector: 'app-blood-sugar-manual-device-node',
  templateUrl: './blood-sugar-manual-device-node.component.html',
  styleUrls: ['./blood-sugar-manual-device-node.component.less'],
})
export class BloodSugarManualDeviceNodeComponent implements NodeComponent {
