...
import { BloodSugarManualDeviceNodeComponent } from './blood-sugar-manual-device-node.component';

describe('BloodSugarManualDeviceNodeComponent', () => {
  let component: BloodSugarManualDeviceNodeComponent;
  let fixture: ComponentFixture<BloodSugarManualDeviceNodeComponent>;
  ...
  async function init(): Promise<NodeRepresentation> {
    await TestBed.configureTestingModule({
      declarations: [BloodSugarManualDeviceNodeComponent],
      imports: [
        ReactiveFormsModule,
        SharedModule,
        HeaderModule,
    ...
    fixture = TestBed.createComponent(BloodSugarManualDeviceNodeComponent);

    component = fixture.componentInstance;
    component.node = node;
    component.nodeMap = { '158': { BloodSugarManualDeviceNode: node } };
    //@ts-ignore
  ...
  it('should parse node', async () => {
    ...
    //@ts-ignore
    expect(representation.nodeModel.comment.name).toBe('158.BS#COMMENT');
  ...
  it('should setup right button with click action', async () => {
    ...
    const scope: any = {
      outputModel: {},
      nodeModel: {
        bloodSugarManualMeasurement: 4.5,
        comment: {
          text: undefined,
        },
      },
    ...
    const output = scope.outputModel['158.BS#BLOODSUGARMEASUREMENTS'];
    ...
    const comment = scope.outputModel['158.BS#COMMENT'];
    expect(comment.name).toBe('158.BS#COMMENT');
